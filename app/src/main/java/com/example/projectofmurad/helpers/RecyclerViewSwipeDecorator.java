...
//                    background.draw(canvas);
                    ...
                    GradientDrawable gradientDrawable = new GradientDrawable();
                    gradientDrawable.setColor(swipeLeftBackgroundColor);
                    gradientDrawable.setBounds(viewHolder.itemView.getRight() + (int) dX, viewHolder.itemView.getTop(), viewHolder.itemView.getRight(), viewHolder.itemView.getBottom());
                    gradientDrawable.setCornerRadius(20);
                    gradientDrawable.setShape(GradientDrawable.RECTANGLE);
//                    gradientDrawable.draw(canvas);
               ...
               /* final Path path = new Path();
                path.addRoundRect(, corners, Path.Direction.CW);b
                canvas.drawPath(path, mPaint);*/
                int backgroundCornerOffset = 10;

                RectF bg = new RectF(viewHolder.itemView.getRight() + ((int) dX) - 2*backgroundCornerOffset,
                        viewHolder.itemView.getTop(), viewHolder.itemView.getRight(), viewHolder.itemView.getBottom());
                Paint p = new Paint();
                p.setColor(swipeLeftBackgroundColor);
                canvas.drawRoundRect(bg, 20, 20, p);

                Log.d("murad", "===========================================decorator=================================");
                Log.d("murad", "decorator viewHolder.itemView.getRight() = " + viewHolder.itemView.getRight());
                Log.d("murad", "decorator viewHolder.itemView.getTop() = " + viewHolder.itemView.getTop());
                Log.d("murad", "decorator viewHolder.itemView.getBottom() = " + viewHolder.itemView.getBottom());
                Log.d("murad", "decorator rect.left = " + (viewHolder.itemView.getRight() + ((int) dX) - backgroundCornerOffset));
                Log.d("murad", "decorator rect.left* = " + (viewHolder.itemView.getRight() + ((int) dX) - 2*backgroundCornerOffset));
                Log.d("murad", "===========================================decorator=================================");
                ...
                if ( swipeLeftActionIconId != 0 && dX < - iconHorizontalMargin ) {
                    ...
                    if ( icon != null ) {
                        iconSize = icon.getIntrinsicHeight();
                        int halfIcon = iconSize / 2;
                        top = viewHolder.itemView.getTop() + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2 - halfIcon);
                ...
                if ( mSwipeLeftText != null && mSwipeLeftText.length() > 0 && dX < - iconHorizontalMargin - iconSize ) {
                    ...
                    int textTop = (int) (viewHolder.itemView.getTop() + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2.0) + textPaint.getTextSize() / 2);
//                    int textTop = (int) (top + iconSize +  textPaint.getTextSize() / 2);
//                    canvas.drawText(mSwipeLeftText, imgLeft - width - ( imgLeft == viewHolder.itemView.getRight() ? iconHorizontalMargin : iconHorizontalMargin/2 ), textTop, textPaint);
                    ...
                    //Log.d("murad", "decorator viewHolder.itemView.getTop() = " + viewHolder.itemView.getTop());
                    //Log.d("murad", "decorator viewHolder.itemView.getBottom() = " + viewHolder.itemView.getBottom());
                    //Log.d("murad", "decorator textPaint.getTextSize() = " + textPaint.getTextSize());
                    //Log.d("murad", "decorator textTop = " + textTop);
                    //Log.d("murad", "===========================================decorator=================================");
                }
            }
        } catch(Exception e) {
