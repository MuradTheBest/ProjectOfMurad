...
public class AdapterForFirebaseWithText extends FirebaseRecyclerAdapter<CalendarEventWithTextOnly, AdapterForFirebaseWithText.ViewHolderForFirebase> {
    ...
    public AdapterForFirebaseWithText(@NonNull FirebaseRecyclerOptions<CalendarEventWithTextOnly> options, LocalDate selectedDate, OnEventListener onEventListener) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterForFirebaseWithText.ViewHolderForFirebase holder, int position, @NonNull CalendarEventWithTextOnly model) {
    ...
    @NonNull
    @Override
    public AdapterForFirebaseWithText.ViewHolderForFirebase onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.event_info, parent, false);

        return new AdapterForFirebaseWithText.ViewHolderForFirebase(view, onEventListener);
    }
