...
public class DayDialogFragmentWithRecyclerViewWithText extends Dialog implements AdapterForFirebaseWithText.OnEventListener{
    ...
    private AdapterForFirebaseWithText adapterForFirebase;

    FirebaseDatabase firebase;
    DatabaseReference databaseReference;

    public DayDialogFragmentWithRecyclerViewWithText(@NonNull Context context, LocalDate passingDate) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterForFirebase = new AdapterForFirebaseWithText(options, passingDate, DayDialogFragmentWithRecyclerViewWithText.this);
