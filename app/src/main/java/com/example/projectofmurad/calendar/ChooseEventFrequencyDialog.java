...
public class ChooseEventFrequencyDialog extends Dialog {
    ...
    public ChooseEventFrequencyDialog(@NonNull Context context) {
        super(context);
    }

    public ChooseEventFrequencyDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected ChooseEventFrequencyDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choose_event_frequency_dialog);
        setCancelable(true);
