 ...
 * Use the {@link EventInfoFragmentMadrich#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EventInfoFragmentMadrich extends DialogFragment implements
    ...
    public EventInfoFragmentMadrich() {
    ...
    @NonNull
    public static EventInfoFragmentMadrich newInstance(CalendarEvent event, boolean isShowsDialog) {
        EventInfoFragmentMadrich fragment = new EventInfoFragmentMadrich();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rv_users.setLayoutManager(new LinearLayoutManagerWrapper(requireContext()).addOnLayoutCompleteListener(
                () -> {
